...
function useSfcTemplateScript(vueUri, vueDoc, template, scriptSetup, scriptSetupRanges, styles, templateScriptData, styleDocuments, styleSourceMaps, templateData, sfcTemplateCompileResult, sfcStyles, scriptLang, context) {
    ...
    const data = (0, reactivity_1.computed)(() => {
        ...
        codeGen.addText('declare var __VLS_wrapComponents: NonNullable<typeof __VLS_component.components> & __VLS_types.GlobalComponents & typeof __VLS_vmUnwrap.components & __VLS_types.PickComponents<typeof __VLS_ctxRaw> & typeof __VLS_ownComponent;\n'); // has __VLS_options
    ...
    function update() {
        ...
        if (((_a = data.value) === null || _a === void 0 ? void 0 : _a.codeGen.getText()) !== ((_b = textDoc.value) === null || _b === void 0 ? void 0 : _b.getText()) || (textDoc.value && textDoc.value.languageId !== newLangId)) {
            if (data.value) {
                const _version = version++;
                textDoc.value = vscode_languageserver_textdocument_1.TextDocument.create(vueUri + '.__VLS_template.' + newLang, newLangId, _version, data.value.codeGen.getText());
